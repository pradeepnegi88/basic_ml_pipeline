...
from entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact, ModelTrainerArtifact, \
    ModelEvaluationArtifact
from entity.model_evaluation_entity import ModelEvaluationEntity
from entity.model_factory import evaluate_regression_model
from housing.exception import CustomException
from housing.logger import logging
from housing.utilities.util import load_data, read_yaml_file, write_yaml_file, load_object, get_dictionary_from_json, \
    check_dir_exists


class ModelEvaluation:

    def __init__(self, model_evaluation_config: ModelEvaluationEntity,
    ...
    def get_best_model(self):
        try:
            ...
            if not check_dir_exists(model_evaluation_file_path):
            ...
            model = load_object(file_path=model_eval_file_content["best_model"]["model_path"])
            return model
        except Exception as e:
            raise CustomException(e, sys) from e
    ...
    def update_evaluation_report(self, model_evaluation_artifact: ModelEvaluationArtifact):
        try:
            ...
            eval_result = {
                "best_model": {
                    "model_path": model_evaluation_artifact.evaluated_model_path,
                }
            }
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            schema_content = get_dictionary_from_json(schema_file_path)
